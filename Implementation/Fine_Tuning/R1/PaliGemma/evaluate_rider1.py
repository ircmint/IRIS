...
adapter on Rider1_NJ's held-out validation split. Mirrors
evaluate_rider1.py / evaluate_rider1_7ep.py's metrics and structure
exactly, adapted for PaliGemma's single-image input + suffix-based
generation (see paligemma_rider1.py for the matching training script and
full rationale).
"""
...
# ============================================================
# CONFIG - must match paligemma_rider1.py so the val split is identical
# ============================================================
...
def main():
    ...
    print("\n===== EVALUATION SUMMARY (Rider1_NJ, PaliGemma-3B) =====")
